...
function _default(api) {
  ...
  function rm(args) {
    (0, _assert.default)(!config.routes, `depot rm is not supported now when routes is configured.`);
    (0, _assert.default)(args._ && args._.length === 2, `Invalid args, checkout depot help rm for more details.`);
    ...
    switch (type) {
      ...
      default:
        throw new Error(`Type ${type} not supported, checkout depot help rm for more details`);
    }
