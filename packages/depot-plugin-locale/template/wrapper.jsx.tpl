...
{{#localeList.length}}
import { _setIntlObject, addLocaleData, IntlProvider, intlShape } from 'depot/locale';
...
if (useLocalStorage && localStorage.getItem('depot_locale') && localeInfo[localStorage.getItem('depot_locale')]) {
  appLocale = localeInfo[localStorage.getItem('depot_locale')];
