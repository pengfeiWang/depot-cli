...
function _default(api) {
  ...
  if (process.env.NODE_ENV === 'development') {
    api.modifyRoutes(memo => {
      const notFoundRoute = {
        component: `
() => React.createElement(require('${(0, _depotUtils.winPath)((0, _path.join)(__dirname, 'NotFound.js'))}').default, { pagesPath: '${paths.pagesPath}', hasRoutesInConfig: ${!!config.routes} })
        `.trim()
      };
