  ...
  function B(a, b) {
    function d(b, d, f) {
      ...
      f &&
        ...
        48 <= c &&
          48 <= e &&
          (b.drawImage(f, c / -2, e / -2, c, e), b.translate(0, e / 2 + 32)));
      b.fillText(v, k / -2, 0);
    ...
    document.head.querySelector('[name="theme-color"]') ||
      c('theme-color', a.theme_color);
  ...
  function D(a) {
    if (p || H) {
      ...
      if (p)
        ...
        try {
          var d = Windows.UI.ViewManagement.ApplicationView.getForCurrentView()
            .titleBar;
        } catch (n) {
          d = null;
        }
        ...
        null === d
          ...
          : ((d.foregroundColor = r(b ? 'black' : 'white')),
