...
class PluginAPI {
  constructor(id, service) {
    ...
    this.debug = (0, _debug.default)(`plugin: ${id}`);
    this.log = _signale.default;
    this.winPath = _depotUtils.winPath;
    this._ = _lodash.default;
    this.compatDirname = _depotUtils.compatDirname;
    this.findJS = _depotUtils.findJS;
    this.findCSS = _depotUtils.findCSS;
