  ...
  return JSON.stringify(clonedRoutes, (key, value) => {
    switch (key) {
      case 'component':
        ...
        const importPath = (0, _path.isAbsolute)(component) ? component : (0, _depotUtils.winPath)((0, _path.relative)(paths.tmpDirPath, component));
      ...
      case 'Routes':
        return `[${value.map(v => `require('${(0, _depotUtils.winPath)(precedingDot((0, _path.relative)(paths.absTmpDirPath, (0, _path.join)(paths.cwd, v))))}').default`).join(', ')}]`;
